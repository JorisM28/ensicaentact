...
\begin{titlepage}
    ...
    \begin{center}
        ...
        \textbf{Tuteur École :} Hélène Le-Bouteiller
    \end{center}
...
\begin{itemize}[label=\textbullet, itemsep=5pt]
    ...
    \item \textbf{Robin} a combiné ses missions de développement avec la gestion du dépôt de code (Git). Sa responsabilité a consisté à maintenir l'intégrité des versions du projet dans un environnement stable. Parallèlement, il a piloté les relations extérieures et veillé à la conformité RGPD ainsi qu'à la structuration de la base de données.
