    ...
    return Drawer(
      child: ListView(
        ...
        children: [
          ...
          ListTile(leading: const Icon(Icons.newspaper), title: const Text("Actualités"), onTap: () => _naviguer(context, NewsPage(user: currentUser ?? {}))),
          ListTile(leading: const Icon(Icons.people), title: const Text("Annuaire"), onTap: () => _naviguer(context, DirectoryPage(user: currentUser ?? {}))),
          ListTile(leading: const Icon(Icons.work), title: const Text("Offres"), onTap: () => _naviguer(context, JobPage(user: currentUser ?? {}))),
          ...
          if ( currentUser != null && (currentUser!['role'] == 'student' || currentUser!['role'] == 'alumni')) ...[
            const Divider(),
            ListTile(leading: const Icon(Icons.event), title: const Text("Proposer un évènement"), onTap: () => _naviguer(context, ProposeEventPage(user: currentUser ?? {}))),
          ...
          if (currentUser != null && currentUser!['role'] == 'admin') ...[
            const Divider(),
            ListTile(leading: const Icon(Icons.security), title: const Text("Modération"), onTap: () => _naviguer(context, PageModeration(user: currentUser ?? {}))),
          ],
        ],
      ),
    );
