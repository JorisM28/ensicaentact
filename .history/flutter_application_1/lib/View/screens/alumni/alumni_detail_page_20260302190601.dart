...
class _AlumniDetailPageState extends State<AlumniDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      ody: Stack(
        children: [
          // Ton contenu principal qui scrolle
          SingleChildScrollView(
            padding: const EdgeInsets.only(top: 60.0, left: 20.0, right: 20.0, bottom: 20.0), // J'ai ajouté un peu de marge en haut (60) pour ne pas que le texte passe sous le bouton retour
            child: Column(
              children: [
          ...
          // 3. LE BOUTON RETOUR SUPERPOSÉ EN HAUT À GAUCHE
          Positioned(
            top: 15,
            left: 15,
