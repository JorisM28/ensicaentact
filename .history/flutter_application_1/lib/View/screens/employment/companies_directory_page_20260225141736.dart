  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: viewModel.isLoadingCompanies
          ...
          : isWideScreen
          ? Row(children: [Expanded(flex: 2, child: _buildList(displaydata)), const VerticalDivider(width: 1), Expanded(flex: 3, child: CompaniesMapWidget(companies: viewModel.allCompanies))])
          : Column(children: [Expanded(flex: 2, child: _buildList(displaydata)), const Divider(height: 1), Expanded(flex: 3, child: CompaniesMapWidget(companies: viewModel.allCompanies))]),
    );
  }
