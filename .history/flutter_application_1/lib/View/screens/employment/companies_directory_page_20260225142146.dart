...
class _CompaniesDirectoryPageState extends State<CompaniesDirectoryPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      ody: viewModel.isLoadingCompanies
          ? const Center(child: CircularProgressIndicator())
          : Column(
              children: [
                // 1. ON AFFICHE LE BOUTON DE FILTRE ICI 👇
                _buildFilterToggle(),
                
                // 2. ON AFFICHE LE RESTE EN DESSOUS (Liste + Carte)
                Expanded(
                  child: isWideScreen
                      ? Row(
                          children: [
                            ...
                            // On passe displaydata à la carte pour qu'elle s'adapte au filtre !
