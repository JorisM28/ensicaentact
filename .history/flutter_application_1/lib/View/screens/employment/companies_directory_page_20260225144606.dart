                  ...
                  child: isWideScreen
                      ? Row(
                          children: [
                            ...
                            // MODIFICATION 1 : Utilisation de mapData au lieu de displaydata
                            Expanded(flex: 3, child: CompaniesMapWidget(companies: mapData))
                          ],
                        )
                      : Column(
                          children: [
  ...
  Widget _buildList(List<Map<String, dynamic>> data) {
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        // MODIFICATION 2 : Vraie vérification de sélection
